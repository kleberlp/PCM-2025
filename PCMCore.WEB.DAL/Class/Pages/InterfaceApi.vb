        ...
        Try
            ...
            Using oSqlDataReader As SqlDataReader = ExecuteReader(sConnection, CommandType.StoredProcedure, "sp_dashboard_silas", oSqlParameter)
                ...
                While oSqlDataReader.Read
                    ...
                    oInfo.empresaAtiva = oSqlDataReader.Item("empresa_ativo")
                    oInfo.unidade = oSqlDataReader.Item("unidade")
                    oInfo.unidadeAtiva = oSqlDataReader.Item("unidade_ativo")
                    ...
                    oInfo.slaDia = oSqlDataReader.Item("os_atendimento_dia")
                    oInfo.slaUmDia = oSqlDataReader.Item("os_atendimento_um_dia")
                    oInfo.slaTresDias = oSqlDataReader.Item("os_atendimento_tres_dias")
                    oInfo.slaCincoDias = oSqlDataReader.Item("os_atendimento_cinco_dias")
                    oInfo.slaAcimaCincoDias = oSqlDataReader.Item("os_atendimento_acima_cinco_dias")
                    oInfo.slaNaoAtendido = oSqlDataReader.Item("os_nao_atendido")
                    oInfo.qtdColaboradorProprio = oSqlDataReader.Item("quantidade_colaborador_proprio")
                    oInfo.qtdColaboradorTerceiro = oSqlDataReader.Item("quantidade_colaborador_terceiro")
                    oInfo.hhDisponivel = oSqlDataReader.Item("hh_disponivel")
                    oInfo.faltasJustificadas = oSqlDataReader.Item("faltas_justificadas")
                    oInfo.faltasNaoJustificadas = oSqlDataReader.Item("fatas_nao_justificadas")
                    oInfo.horasCorretivas = oSqlDataReader.Item("horas_corretivas")
                    oInfo.horasPreventivas = oSqlDataReader.Item("horas_preventivas")
                    oInfo.horasPMOC = oSqlDataReader.Item("horas_pmoc")
                    oInfo.horasUH = oSqlDataReader.Item("horas_uh")
                    oInfo.hhApontado = oSqlDataReader.Item("total_apontado")
                    oInfo.hhOciosas = oSqlDataReader.Item("horas_ociosas")
