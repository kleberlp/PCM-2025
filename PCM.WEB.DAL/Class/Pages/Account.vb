    ...
    Public Sub LoadPerfil(ByVal iCodigoEmpresa As Integer,
        ...
        Try
            ...
            If oSqlDataReader.Read() Then
                ...
                oFormularioVisualizar.rel_gov_discrepancias = IIf(IsDBNull(oSqlDataReader.Item("rel_gov_discrepancias")) = False AndAlso oSqlDataReader.Item("rel_gov_discrepancias") = "S", True, False)
