    ...
    Public Function InfoOrdemServico(ByVal iCodigoEmpresa As Integer,
        ...
        Try
            ...
            While oSqlDataReader.Read
                ...
                oReturn.quantidade_atrasada_condo = oSqlDataReader.Item("quantidade_atrasada_condo")
                ...
                oReturn.quantidade_backlog_condo = oSqlDataReader.Item("quantidade_backlog_condo")
                oReturn.quantidade_atrasada_pool = oSqlDataReader.Item("quantidade_atrasada_pool")
                ...
                oReturn.quantidade_backlog_pool = oSqlDataReader.Item("quantidade_backlog_pool")
