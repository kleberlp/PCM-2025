/* =============================================================================
   Carga do manual — versao a prova de codificacao (emojis como NCHAR).

   Por que existe: rodar a carga original no SSMS/sqlcmd sem UTF-8, OU numa
   base cujas colunas nasceram varchar, transforma cada emoji em '??'. Aqui os
   emojis sao NCHAR(0x....) — ASCII puro no arquivo, entao qualquer editor/cliente
   le igual — e o preambulo garante que as colunas sejam nvarchar. Roda em
   qualquer encoding, com o mesmo resultado.

   Rode DEPOIS de 2026-08-27_manual_integrado.sql. Idempotente (refaz a carga).
   ============================================================================= */

-- ---- Garante nvarchar nas colunas de texto (emoji nao cabe em varchar) -------
IF COL_LENGTH('dbo.tb_manual','titulo') IS NOT NULL
BEGIN
    IF EXISTS (SELECT 1 FROM sys.columns c JOIN sys.types t ON t.user_type_id=c.system_type_id
               WHERE c.object_id=OBJECT_ID('dbo.tb_manual') AND c.name='titulo' AND t.name='varchar')
        ALTER TABLE dbo.tb_manual ALTER COLUMN titulo nvarchar(200) NOT NULL;
    IF EXISTS (SELECT 1 FROM sys.columns c JOIN sys.types t ON t.user_type_id=c.system_type_id
               WHERE c.object_id=OBJECT_ID('dbo.tb_manual') AND c.name='subtitulo' AND t.name='varchar')
        ALTER TABLE dbo.tb_manual ALTER COLUMN subtitulo nvarchar(300) NULL;
END
IF COL_LENGTH('dbo.tb_manual_item','titulo') IS NOT NULL
BEGIN
    IF EXISTS (SELECT 1 FROM sys.columns c JOIN sys.types t ON t.user_type_id=c.system_type_id
               WHERE c.object_id=OBJECT_ID('dbo.tb_manual_item') AND c.name='titulo' AND t.name='varchar')
        ALTER TABLE dbo.tb_manual_item ALTER COLUMN titulo nvarchar(200) NOT NULL;
    IF EXISTS (SELECT 1 FROM sys.columns c JOIN sys.types t ON t.user_type_id=c.system_type_id
               WHERE c.object_id=OBJECT_ID('dbo.tb_manual_item') AND c.name='conteudo' AND t.name='varchar')
        ALTER TABLE dbo.tb_manual_item ALTER COLUMN conteudo nvarchar(max) NULL;
    IF EXISTS (SELECT 1 FROM sys.columns c JOIN sys.types t ON t.user_type_id=c.system_type_id
               WHERE c.object_id=OBJECT_ID('dbo.tb_manual_item') AND c.name='nota' AND t.name='varchar')
        ALTER TABLE dbo.tb_manual_item ALTER COLUMN nota nvarchar(1000) NULL;
END
GO
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 1, N''+NCHAR(0xD83C)+NCHAR(0xDFAF)+N' O que você vai conquistar', N'Esta seção explica como o sistema organiza os níveis de autoridade entre os diferentes tipos de usuário e como configurar essa estrutura. Ao dominar a hierarquia de perfis, você garante que cada colaborador veja apenas o que precisa ver, que as aprovações sigam o fluxo correto de autoridade e que dados sensíveis (financeiro, relatórios de rede) fiquem protegidos dos perfis operacionais.', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 2, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'> [!WARNING]
> **ANTES DE COMEÇAR**
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Perfil CRIADO | → | 2️⃣ Permissões DEFINIDAS | → | 3️⃣ Hierarquia DEFINIDA | → | 4️⃣ Usuário VINCULADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Acesso Ativo |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Acessar a tela de Hierarquia de Perfis
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDD0D)+N' Tabela de Campos para Consulta Rápida', N'| Campo | Descrição | Obrigatório? | Exemplo / Regra |
| :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 6, N''+NCHAR(0xD83D)+NCHAR(0xDCA1)+N' Boas Práticas e Pontos de Atenção', N'> [!BOAPRATICA]
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 8, N''+NCHAR(0xD83D)+NCHAR(0xDD17)+N' Conexões com Outros Módulos', N'| O que alimenta este módulo | O que este módulo alimenta | Integrações automáticas |
| :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 2, N''+NCHAR(0xD83C)+NCHAR(0xDFAF)+N' O que você vai conquistar', N'Ao dominar esta seção você será capaz de consultar e gerenciar o status das empresas (fornecedores e prestadores de serviço) cadastradas a nível administrativo do sistema, diferente do Cadastro Básico > Fornecedor (seção 2.15), que é o cadastro operacional usado em estoque e ordens de compra. Esta tela em Administração é a visão consolidada de todas as empresas parceiras da rede.', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'> [!WARNING]
> **ANTES DE COMEÇAR**
> Você precisa ter perfil Administrador para acessar esta tela.', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Listagem ACESSADA | → | 2️⃣ Empresa LOCALIZADA | → | 3️⃣ Ativar/Inativar | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Reflete no Sistema |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Consultar e gerenciar empresas cadastradas
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 6, N''+NCHAR(0xD83D)+NCHAR(0xDD0D)+N' Tabela de Campos para Consulta Rápida', N'| Campo | Descrição | Obrigatório? | Exemplo / Regra |
| :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 7, N''+NCHAR(0xD83D)+NCHAR(0xDCA1)+N' Boas Práticas e Pontos de Atenção', N'> [!BOAPRATICA]
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 9, N''+NCHAR(0xD83D)+NCHAR(0xDD17)+N' Conexões com Outros Módulos', N'| O que alimenta este módulo | O que este módulo alimenta | Integrações automáticas |
| :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Novo CLIENTE | → | 2️⃣ Dados FISCAIS | → | 3️⃣ Cliente SALVO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Disponível p/ Vínculo |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Cadastrar um Cliente
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Painel ACESSADO | → | 2️⃣ Pesos AJUSTADOS | → | 3️⃣ Soma 100% CONFIRMADA | → | 4️⃣ Config. SALVA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Nota Geral Recalculada |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Configurar os pesos
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 1, N'Visão geral', N'| '+NCHAR(0xD83D)+NCHAR(0xDC64)+N'  Para quem é esta seção? | '+NCHAR(0xD83D)+NCHAR(0xDCCD)+N'  Onde está no sistema? |
| :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Dados FISCAIS | → | 2️⃣ Endereço e CONTATO | → | 3️⃣ Config. OPERACIONAIS | → | 4️⃣ Dados de EDIFICAÇÃO | → | 5️⃣ Logos ENVIADOS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Unidade Salva |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1 Criar uma nova unidade
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Função CRIADA | → | 2️⃣ Colaborador CADASTRADO | → | 3️⃣ Função VINCULADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Filtro por Especialidade |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Cadastro Básico > Função — listagem com as funções reais cadastradas](/screenshots/cadastro-funcao-listagem.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Departamento CRIADO | → | 2️⃣ Colaborador VINCULADO | → | 3️⃣ Gestor VINCULADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Despesas por Depto. |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Cadastro Básico > Departamento — listagem com os departamentos reais cadastrados](/screenshots/cadastro-departamento-listagem.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Departamento EXISTENTE | → | 2️⃣ Usuário Gestor CRIADO | → | 3️⃣ Vínculo CRIADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Notificações Ativas |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Tela Departamento — Gestor — listagem de vínculos com botão Novo](/screenshots/cadastro-departamento-gestor.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Tipo DEFINIDO | → | 2️⃣ Grupos ORGANIZADOS | → | 3️⃣ Itens ADICIONADOS | → | 4️⃣ Checklist VINCULADO | → | 5️⃣ Resposta em CAMPO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Histórico Alimentado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Criar o cabeçalho do checklist
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Prioridade CRIADA | → | 2️⃣ OS ABERTA | → | 3️⃣ Cor na LISTAGEM | → | 4️⃣ SLA CALCULADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Alerta por E-mail |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Cadastro Básico > Prioridade — listagem de prioridades com campos de notificação](/screenshots/cadastro-prioridade-listagem.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ CNPJ e Dados FISCAIS | → | 2️⃣ Categoria VINCULADA | → | 3️⃣ Fornecedor ATIVO | → | 4️⃣ Entrada de ESTOQUE | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Ordem de Compra |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Formulário de cadastro de fornecedor — dados fiscais, endereco e classificação](/screenshots/cadastro-fornecedor-novo.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Grupo CRIADO | → | 2️⃣ Produto CADASTRADO | → | 3️⃣ Ponto de Reposição DEFINIDO | → | 4️⃣ Entrada REGISTRADA | → | 5️⃣ Saída REGISTRADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Saldo Atualizado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'1. Acesse Cadastro Básico > Grupo e clique em Novo.
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Item Geral CRIADO | → | 2️⃣ Categoria DEFINIDA | → | 3️⃣ Atividade MAPEADA | → | 4️⃣ OS ABERTA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Categoria e Item |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Cadastro Básico > Mapa de Manutenção — combinacao de Categoria, Item Geral e Título da atividade](/screenshots/cadastro-mapa-manutencao-novo.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Item CRIADO | → | 2️⃣ Periodicidade DEFINIDA | → | 3️⃣ Checklist VINCULADO | → | 4️⃣ Cronograma GERADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Execução pelo Técnico |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  A estrutura do item de checklist PMOC
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Unidade SELECIONADA | → | 2️⃣ Setor CRIADO | → | 3️⃣ Locais ADICIONADOS | → | 4️⃣ Infraestrutura PREENCHIDA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Disponível no Sistema |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Criar um novo setor
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Setor CADASTRADO | → | 2️⃣ Tipo de U.H. DEFINIDO | → | 3️⃣ U.H. CRIADA | → | 4️⃣ Características TÉCNICAS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' U.H. Salva |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Cadastrar uma U.H.
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Checklists CRIADOS | → | 2️⃣ Tipo de U.H. DEFINIDO | → | 3️⃣ Tipo de Cama DEFINIDO | → | 4️⃣ Tipo de AC DEFINIDO | → | 5️⃣ U.H. CADASTRADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' AC Cadastrado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Configurar Tipo de U.H.
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 6, N''+NCHAR(0xD83D)+NCHAR(0xDD0D)+N' Tabela de Campos para Consulta Rápida', N'Tipo de U.H.:
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ TAG DEFINIDA | → | 2️⃣ Família SELECIONADA | → | 3️⃣ Localização DEFINIDA | → | 4️⃣ Dados TÉCNICOS | → | 5️⃣ Documentação ANEXADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Ativo no Sistema |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Cadastrar um novo equipamento
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ TAG DEFINIDA | → | 2️⃣ Tipo SELECIONADO | → | 3️⃣ Localização DEFINIDA | → | 4️⃣ Potência REGISTRADA | → | 5️⃣ Fabricante/Série INFORMADOS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Entra no PMOC |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Cadastrar um aparelho de ar condicionado
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Família CRIADA | → | 2️⃣ Equipamento CADASTRADO | → | 3️⃣ Família VINCULADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Relatórios por Família |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Cadastro Básico > Família - Equipamento — listagem com botão Novo](/screenshots/cadastro-familia-equipamento-listagem.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Categoria CRIADA | → | 2️⃣ OS ABERTA | → | 3️⃣ SLA MEDIDO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Custo por Categoria |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Cadastro Básico > Categoria - Serviço — listagem com as categorias reais cadastradas](/screenshots/cadastro-categoria-servico-listagem.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Depto. CADASTRADO | → | 2️⃣ Função CADASTRADA | → | 3️⃣ Usuário CRIADO | → | 4️⃣ Colaborador CADASTRADO | → | 5️⃣ Custo/Hora DEFINIDO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Disponível para OS |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Cadastrar um novo colaborador
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'O Plano de Ação pode nascer de duas origens e segue o mesmo ciclo de execução:

| 1️⃣ Origem: AUDITORIA | → | 2️⃣ Ou Criação: MANUAL | → | 3️⃣ Atribuição: RESPONSÁVEL | → | 4️⃣ Execução: % ATUALIZADO | → | 5️⃣ Conclusão: 100% | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Histórico p/ Auditoria |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Criar um Plano de Ação manualmente
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Apontamento CONCLUÍDO | → | 2️⃣ Registro AUTOMÁTICO | → | 3️⃣ Histórico FILTRADO | → | 4️⃣ Detalhes VISUALIZADOS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Exportação |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Consultar o histórico de Preventivas
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'O módulo de Laudo funciona como um calendário de obrigações legais com três estados visuais:

| Cor na listagem | Significado | Ação necessária |
| :--- | :--- | :--- |
| '+NCHAR(0xD83D)+NCHAR(0xDD34)+N'  VERMELHO | Laudo vencido: validade expirada | Contratar renovação imediatamente. Risco de interdição em fiscalização |
| '+NCHAR(0xD83D)+NCHAR(0xDFE1)+N'  AMARELO | Laudo vence no mês corrente (próximos 30 dias) | Iniciar processo de renovação agora: evite deixar vencer |
| '+NCHAR(0xD83D)+NCHAR(0xDD35)+N'  AZUL | Laudo com vencimento futuro: em dia | Monitorar. Sem ação necessária no momento |
| '+NCHAR(0xD83D)+NCHAR(0xDFE2)+N'  VERDE | Laudo renovado e upload realizado | Documento válido e evidência digital arquivada |


Ciclo completo de gestão de um laudo:

| 1️⃣ Tipo CADASTRADO | → | 2️⃣ Vencimento GERADO | → | 3️⃣ Laudo VENCIDO | → | 4️⃣ Renovação CONTRATADA | → | 5️⃣ Upload REALIZADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Conformidade no Dashboard |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Monitorar o painel de laudos
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'O PMOC no PCM by SIM é dividido em quatro grandes etapas:

| 1️⃣ Plano CADASTRADO | → | 2️⃣ Cronograma GERADO | → | 3️⃣ Execução TÉCNICA | → | 4️⃣ Histórico REGISTRADO | → | 5️⃣ Dossiê TÉCNICO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Renovação do Plano |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Cadastrar o plano PMOC e registrar a ART
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'A requisição percorre um ciclo de aprovação antes de gerar ação:

| 1️⃣ Solicitação AGUARDANDO | → | 2️⃣ Análise do GESTOR | → | 3️⃣ Aprovada? OS/OC GERADA | → | 4️⃣ Reprovada? Solicitante NOTIFICADO | → | 5️⃣ Histórico REGISTRADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Auditável |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Abrir uma nova requisição
...
| :--- | :--- | :--- | :--- |
| PENDENTE | '+NCHAR(0xD83D)+NCHAR(0xDFE1)+N' Amarelo | Enviada, aguardando análise do gestor | Aguardar: não reabrir a mesma requisição |
| APROVADO | '+NCHAR(0xD83D)+NCHAR(0xDFE2)+N' Verde | Deveria gerar OS ou OC automaticamente — ver aviso abaixo sobre a tela de aprovação | Acompanhar a execução na tela de OS |
| REPROVADO | '+NCHAR(0xD83D)+NCHAR(0xDD34)+N' Vermelho | Negada pelo gestor | Ler o motivo nas observações e avaliar nova abordagem |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'A aprovação fecha o ciclo iniciado pela abertura de requisição e dispara a ação correspondente:

| 1️⃣ Requisição AGUARDANDO | → | 2️⃣ Análise do GESTOR | → | 3️⃣ Aprovada? OS/OC GERADA | → | 4️⃣ Reprovada? Solicitante NOTIFICADO | → | 5️⃣ Motivo REGISTRADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Fila Atualizada |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'> [!DANGER]
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Falta COMUNICADA | → | 2️⃣ Registro no SISTEMA | → | 3️⃣ OS REDISTRIBUÍDA | → | 4️⃣ Dado de ABSENTEÍSMO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Retorno Registrado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Registrar uma falta
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Produto CADASTRADO | → | 2️⃣ Entrada REGISTRADA | → | 3️⃣ Saldo DISPONÍVEL | → | 4️⃣ Saída REGISTRADA | → | 5️⃣ Custo na OS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Inventário Periódico |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1.A  Registrar entrada de material (recebimento de nota fiscal)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Necessidade IDENTIFICADA | → | 2️⃣ Requisição ABERTA | → | 3️⃣ Aprovação do GESTOR | → | 4️⃣ Ordem de Compra GERADA | → | 5️⃣ Compra REALIZADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Entrada no Estoque |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Tela de Requisição de Compra - listagem com status AGUARDANDO APROVACAO, APROVADO e REPROVADO](/screenshots/estoque-requisicao-compra-listagem.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 6, N''+NCHAR(0xD83D)+NCHAR(0xDD0D)+N' Tabela de Campos para Consulta Rápida', N'| Status | Cor | Significado | Próxima acao |
| :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Requisição APROVADA | → | 2️⃣ OC CRIADA | → | 3️⃣ Pedido ENVIADO | → | 4️⃣ Material RECEBIDO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' OC Concluída |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Estoque > Ordem de Compra — listagem com status, quantidades pedidas, recebidas e pendentes](/screenshots/estoque-ordem-compra.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'> [!INFO]
> **RELATÓRIO HISTÓRICO**
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Apontamentos REGISTRADOS | → | 2️⃣ Relatório FILTRADO | → | 3️⃣ Padrões IDENTIFICADOS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Ação Corretiva |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Governança > Relatório de Discrepâncias — indicadores e tabela histórica](/screenshots/governanca-relatorio-discrepancias.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Planejamento FEITO | → | 2️⃣ U.H. PENDENTE | → | 3️⃣ Checklist EXECUTADO | → | 4️⃣ Status ATUALIZADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Aguardando/Concluído |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Governança > Checklist — grid de U.H.s por Bloco e Andar com legenda de status](/screenshots/governanca-checklist-grid.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Modelo CADASTRADO | → | 2️⃣ Auditoria INICIADA | → | 3️⃣ Checklist RESPONDIDO | → | 4️⃣ Nota CALCULADA | → | 5️⃣ Plano de Ação GERADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Histórico Arquivado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Iniciar uma auditoria corporativa
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'![Auditoria > Normas e Procedimentos — listagem de documentos por tipo e status](/screenshots/auditoria-normas-procedimentos.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Auditoria REALIZADA | → | 2️⃣ Histórico GERADO | → | 3️⃣ Normas PUBLICADAS | → | 4️⃣ Evolução ANALISADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Evidência Disponível |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Consultar o histórico de auditorias corporativas
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'| Tela | URL | Função |
| :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Contrato VIGENTE | → | 2️⃣ Serviço REALIZADO | → | 3️⃣ Laudo EMITIDO | → | 4️⃣ Laudo REGISTRADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Auditoria Interna |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![A&B > Auditoria Externa — formulário de registro com nota, conformidades e plano de acao](/screenshots/aeb-auditoria-externa.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 6, N''+NCHAR(0xD83D)+NCHAR(0xDD0D)+N' Tabela de Campos para Consulta Rápida', N'| Laudo | Periodicidade mínima | Órgão competente | Risco se vencido |
| :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Estrutura CRIADA | → | 2️⃣ Checklist PUBLICADO | → | 3️⃣ Auditor RESPONDE | → | 4️⃣ Nota CALCULADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Histórico Arquivado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  A estrutura de 3 níveis com peso
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Grupo CRIADO | → | 2️⃣ Item CRIADO | → | 3️⃣ Unidade DEFINIDA | → | 4️⃣ Meta CONFIGURADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Disponível p/ Lançamento |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Cadastro Básico > Grupo — Item de Medição — formulário de criação](/screenshots/cadastro-grupo-item-medicao.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Ocupação INFORMADA | → | 2️⃣ Leitura REGISTRADA | → | 3️⃣ KPI CALCULADO | → | 4️⃣ Desvio IDENTIFICADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' OS de Inspeção Aberta |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Green Planet > Medição — grade de medidores com campos de leitura e dados de ocupação](/screenshots/green-planet-medicao.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'| Relatorio | Caminho no sistema | O que responde |
| :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Relatório SELECIONADO | → | 2️⃣ Filtros APLICADOS | → | 3️⃣ Visualização GERADA | → | 4️⃣ Dados EXPORTADOS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Análise de BI |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Tela de relatorio — filtros laterais com Unidade, Período, Categoria e botao Filtrar](/screenshots/relatorio-generico.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 6, N''+NCHAR(0xD83D)+NCHAR(0xDD0D)+N' Tabela de Campos para Consulta Rápida', N'Este e o relatorio mais estratégico do sistema. Ele responde a pergunta que todo gestor enfrenta: devo continuar mantendo este equipamento ou e hora de substituir?
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'| Relatório | URL | O que mostra |
| :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Apontamentos REALIZADOS | → | 2️⃣ Dados CONSOLIDADOS | → | 3️⃣ Relatório FILTRADO | → | 4️⃣ Análise GERENCIAL | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Ação Corretiva |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Governança > Relatório Camareira x UH — exemplo de relatório de produtividade em matriz](/screenshots/governanca-relatorio-camareira-uh.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'| Dado | Direção | De | Para | Benefício |
| :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Credenciais OBTIDAS | → | 2️⃣ Configuração no PCM | → | 3️⃣ Frequência DEFINIDA | → | 4️⃣ Config. SALVA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Sincronia Monitorada |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Configuração > Interface Opera — campos de autenticação e frequência](/screenshots/config-interface-opera-real.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Item AUDITÁVEL | → | 2️⃣ Apontamento REALIZADO | → | 3️⃣ Relatório FILTRADO | → | 4️⃣ Dados EXPORTADOS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Evidências Apresentadas |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Auditoria > Relatório itens Auditáveis — filtro por Unidade, Período e item do Mapa de Manutenção](/screenshots/relatorio-dinamico.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'| Tela | URL | Função principal |
| :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Modelo BAIXADO | → | 2️⃣ Dados PREENCHIDOS | → | 3️⃣ Tabela/Unidade SELECIONADA | → | 4️⃣ Arquivo ENVIADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Importação Processada |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Upload > PMOC — seleção de Unidade, Tabela e upload de planilha](/screenshots/upload-pmoc.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Bem ADQUIRIDO | → | 2️⃣ Etiqueta GERADA | → | 3️⃣ Ativo CADASTRADO | → | 4️⃣ Localização/Responsável DEFINIDOS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Pronto p/ Movimentação |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Ativo Fixo > Ativo Fixo — listagem com filtros de Unidade, Código, Descrição, Status e Localização](/screenshots/ativo-fixo-listagem.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 2, N''+NCHAR(0xD83C)+NCHAR(0xDFAF)+N' O que você vai conquistar', N'Ao dominar esta seção você será capaz de registrar formalmente toda mudança relevante na vida de um ativo, baixa (descarte), manutenção ou transferência de localização, mantendo um histórico completo e rastreável de cada bem patrimonial.', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'> [!WARNING]
> **ANTES DE COMEÇAR**
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Evento IDENTIFICADO | → | 2️⃣ Movimentação REGISTRADA | → | 3️⃣ Status/Localização ATUALIZADOS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Histórico Consultável |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Ativo Fixo > Movimentação — filtros de Unidade, Tipo, Documento, Período, Origem e Destino](/screenshots/ativo-fixo-movimentacao.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 2, N''+NCHAR(0xD83C)+NCHAR(0xDFAF)+N' O que você vai conquistar', N'Ao dominar esta seção você será capaz de abrir, acompanhar e encerrar as campanhas de inventário físico de ativos fixos, o processo periódico que confirma se o que está cadastrado no sistema realmente existe nos andares do hotel.', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'> [!INFO]
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Campanha ABERTA | → | 2️⃣ Contagem FÍSICA | → | 3️⃣ Contagem REGISTRADA | → | 4️⃣ Divergências IDENTIFICADAS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Campanha Finalizada |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Ativo Fixo > Gestão de Inventário — listagem de campanhas com Status ABERTO/EM EXECUÇÃO/FINALIZADO](/screenshots/ativo-fixo-gestao-inventario.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 2, N''+NCHAR(0xD83C)+NCHAR(0xDFAF)+N' O que você vai conquistar', N'Ao dominar esta seção você será capaz de realizar a contagem física dos ativos, andar por andar e ambiente por ambiente, confirmando no sistema que cada bem etiquetado realmente está onde o cadastro (seção 8.1) diz que está.', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'> [!WARNING]
> **ANTES DE COMEÇAR**
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Campanha ABERTA | → | 2️⃣ Setor/Local SELECIONADOS | → | 3️⃣ Código do Ativo INFORMADO | → | 4️⃣ Contagem REGISTRADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Divergências Analisadas |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Ativo Fixo > Inventário — seleção de Setor, Local/U.H. e campo de código do ativo para contagem](/screenshots/ativo-fixo-inventario-contagem.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Ativo sem CADASTRO | → | 2️⃣ Cadastro na HORA | → | 3️⃣ 1ª Foto HAND-ON | → | 4️⃣ Comparação HAND-OFF | → | 5️⃣ Divergência IDENTIFICADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Não Conforme? Marcado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Cadastrar um ativo durante o inventário
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Budget DEFINIDO | → | 2️⃣ Despesas LANÇADAS | → | 3️⃣ Contratos REGISTRADOS | → | 4️⃣ Gasto Real ACUMULADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Saldo Calculado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Finanças > Controle de Gastos — tabela comparativa Previsão vs Gasto Real vs Saldo](/screenshots/financas-controle-gastos.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 2, N''+NCHAR(0xD83C)+NCHAR(0xDFAF)+N' O que você vai conquistar', N'Ao dominar esta seção você será capaz de registrar despesas que não passam pelo estoque, serviços de terceiros, taxas, despesas administrativas, com evidência digital anexada, alimentando automaticamente o Controle de Gastos (seção A.1).', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'> [!WARNING]
> **ANTES DE COMEÇAR**
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Despesa IDENTIFICADA | → | 2️⃣ Competência DEFINIDA | → | 3️⃣ Evidência ANEXADA | → | 4️⃣ Despesa SALVA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Gasto Real Atualizado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Finanças > Despesa — formulário de novo lançamento](/screenshots/financas-despesa-novo.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Fornecedor SELECIONADO | → | 2️⃣ Contrato CADASTRADO | → | 3️⃣ Vigência MONITORADA | → | 4️⃣ Renovação AVALIADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Renovar ou Encerrar |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Finanças > Contrato — formulário de cadastro com vigência e valor mensal](/screenshots/financas-contrato-novo.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Usuários ACESSADO | → | 2️⃣ Usuário CRIADO | → | 3️⃣ Perfil DEFINIDO | → | 4️⃣ Colaborador VINCULADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Usuário Salvo |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Acessar e filtrar a listagem de usuários
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Credenciais RECEBIDAS | → | 2️⃣ Login REALIZADO | → | 3️⃣ Senha ATUALIZADA | → | 4️⃣ Permissões CONFERIDAS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Sistema em Uso |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Tela de login real do PCM by SIM — campos ID-Usuário e Senha](/screenshots/login-tela-real.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Apontamentos REALIZADOS | → | 2️⃣ Dados CONSOLIDADOS | → | 3️⃣ Painel ATUALIZADO | → | 4️⃣ Desvio IDENTIFICADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Ação Corretiva |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Planejamento DEFINIDO | → | 2️⃣ Camareira NOTIFICADA | → | 3️⃣ Arrumação EXECUTADA | → | 4️⃣ Apontamento REGISTRADO | → | 5️⃣ Vistoria REALIZADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' U.H. Liberada |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Acompanhar e apontar arrumações em tempo real
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'Uma OS percorre as seguintes etapas desde a abertura até o encerramento:

| 1️⃣ Abertura PENDENTE | → | 2️⃣ Atribuição VINCULADA | → | 3️⃣ Execução EM ANDAMENTO | → | 4️⃣ Apontamento — | → | 5️⃣ Encerramento CONCLUÍDA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Indicadores Dashboard |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Abrir uma nova Ordem de Serviço
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 9, N''+NCHAR(0xD83D)+NCHAR(0xDD17)+N' Conexões com Outros Módulos', N'| O que alimenta a OS | O que a OS alimenta | Integrações automáticas |
| :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 2, N''+NCHAR(0xD83C)+NCHAR(0xDFAF)+N' O que você vai conquistar', N'Ao finalizar esta seção você saberá atualizar seu nome de exibição e redefinir sua senha de acesso de forma segura, sem precisar sair do que está fazendo no sistema. Manter a senha atualizada é essencial porque todo apontamento de OS, preventiva, vistoria ou auditoria fica registrado com a sua identificação. Proteger o seu acesso é proteger a integridade dos registros operacionais da unidade.', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'> [!WARNING]
> Você precisa estar logado no sistema com seu usuário e senha atuais.', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Perfil ABERTO | → | 2️⃣ Nome ATUALIZADO | → | 3️⃣ Nova Senha DIGITADA | → | 4️⃣ Senha CONFIRMADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Alterações Salvas |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Abrir o painel de perfil
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 2, N''+NCHAR(0xD83C)+NCHAR(0xDFAF)+N' O que mudou este mês', N'> [!NOVIDADE Discrepâncias — Apontamento Avançado]
...
'+NCHAR(0xD83D)+NCHAR(0xDCD6)+N' Manual completo: seção 5.10 (e 5.11 para o relatório histórico)
...
'+NCHAR(0xD83D)+NCHAR(0xDCD6)+N' Manual completo: seção 5.13 (e seção 2.13 para como configurar o checklist)
...
'+NCHAR(0xD83D)+NCHAR(0xDCD6)+N' Manual completo: seções 8.1 a 8.5
...
'+NCHAR(0xD83D)+NCHAR(0xDCD6)+N' Manual completo: seção 1.6 (configuração) e seção 7.10 (como o Score e a Nota são calculados e exibidos)', NULL, NULL, NULL, NULL, 1);
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Planejamento do TURNO | → | 2️⃣ Limpeza EXECUTADA | → | 3️⃣ Apontamento DETALHADO | → | 4️⃣ Divergência IDENTIFICADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Ação Corretiva |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Governança > Discrepâncias — painel de indicadores e grade detalhada por U.H.](/screenshots/governanca-discrepancias.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'Ciclo de vida de uma rotina no sistema:

| 1️⃣ Plano CADASTRADO | → | 2️⃣ Horário CONFIGURADO | → | 3️⃣ Execução EM ANDAMENTO | → | 4️⃣ Checklist CONCLUÍDO | → | 5️⃣ Ocorrência? OS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Histórico Dashboard |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Visualizar as rotinas do dia e do turno
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Material PREPARADO | → | 2️⃣ Módulo DEFINIDO | → | 3️⃣ Arquivo ENVIADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Consulta por Unidade/Módulo |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Cadastro Básico > Treinamento — formulário com Unidade, Módulo, Descrição, Comentários e Arquivo](/screenshots/treinamento-cadastro.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Carga PESADA | → | 2️⃣ Lavagem REALIZADA | → | 3️⃣ Apontamento REGISTRADO | → | 4️⃣ Peso Relave CONFERIDO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Histórico Atualizado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Lavanderia > Apontamento — campos de peso, peso relave, máquinas e grade de enxoval](/screenshots/lavanderia-apontamento.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 2, N''+NCHAR(0xD83C)+NCHAR(0xDFAF)+N' O que você vai conquistar', N'Ao dominar esta seção você saberá planejar, executar e registrar manutenções preventivas em equipamentos e instalações da unidade. A preventiva é a estratégia que evita quebras inesperadas: ao invés de esperar um ativo falhar, o sistema agenda automaticamente as intervenções com base na periodicidade configurada. Isso reduz o custo total de manutenção, aumenta a vida útil dos equipamentos e garante a conformidade com normas legais como o PMOC (climatização) e a NR-13 (vasos de pressão).', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 3, N''+NCHAR(0xD83D)+NCHAR(0xDCCB)+N' Antes de começar', N'> [!WARNING]
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'Uma preventiva percorre o seguinte ciclo de vida no sistema:

| 1️⃣ Plano CADASTRADO | → | 2️⃣ Geração PENDENTE | → | 3️⃣ Início EM ANDAMENTO | → | 4️⃣ Checklist CONCLUÍDO | → | 5️⃣ Falha? OS CORRETIVA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Histórico e BI |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Visualizar o cronograma de preventivas
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 6, N''+NCHAR(0xD83D)+NCHAR(0xDD0D)+N' Tabela de Campos para Consulta Rápida', N'Campos do apontamento de preventiva:
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Enxoval SEPARADO | → | 2️⃣ Movimento REGISTRADO | → | 3️⃣ Comprovante IMPRESSO | → | 4️⃣ Inventário PERIÓDICO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Movimentação Analisada |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Registrar envio para lavanderia
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Periodicidade VENCIDA | → | 2️⃣ U.H. PENDENTE | → | 3️⃣ Vistoria REALIZADA | → | 4️⃣ Checklist RESPONDIDO | → | 5️⃣ Apontamento SALVO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Status Atualizado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Consultar o painel de status do Checklist
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 7, N''+NCHAR(0xD83D)+NCHAR(0xDCA1)+N' Boas Práticas e Pontos de Atenção', N'> [!WARNING]
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Arrumação APONTADA | → | 2️⃣ Vistoria do SUPERVISOR | → | 3️⃣ NC/Retrabalho REGISTRADOS | → | 4️⃣ Score CALCULADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Ranking Atualizado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Desempenho de Governança — KPIs, gauge de score e gráficos de evolução](/screenshots/desempenho-governanca-individual.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Atividade CADASTRADA | → | 2️⃣ Aplicação nas U.H.s | → | 3️⃣ Execução pelo TÉCNICO | → | 4️⃣ Conclusão REGISTRADA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Status Atualizado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Consultar e filtrar atividades por U.H.
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Parâmetros GERAIS | → | 2️⃣ Metas por UNIDADE | → | 3️⃣ Config. SALVA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Desempenho Recalculado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Administração > Metas e Parâmetros de Governança — pesos, metas padrão e tabela por unidade](/screenshots/metas-parametros-governanca.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Agendamento CONFIGURADO | → | 2️⃣ Prazo VENCIDO | → | 3️⃣ U.H. PENDENTE | → | 4️⃣ Dedetização EXECUTADA | → | 5️⃣ Registro SALVO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Ciclo Reinicia |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Configurar o agendamento em massa
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Limpeza EXECUTADA | → | 2️⃣ Apontamento SALVO | → | 3️⃣ Vistoria REALIZADA | → | 4️⃣ Dados CONSOLIDADOS | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Relatório em Matriz |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Governança > Relatório Camareira x UH — matriz de camareira por dia do mês](/screenshots/governanca-relatorio-camareira-uh.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Vistoria AGENDADA | → | 2️⃣ Apontamento INICIADO | → | 3️⃣ Horas REGISTRADAS | → | 4️⃣ Laudo ANEXADO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Custo Lançado |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'> [!INFO]
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Local CADASTRADO | → | 2️⃣ Periodicidade VENCIDA | → | 3️⃣ Status PENDENTE/ATRASADO | → | 4️⃣ Vistoria REALIZADA | → | 5️⃣ Não Conforme? OS ABERTA | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Local em Dia |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'### 4.1  Visão geral, KPIs e locais por setor
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Evento IDENTIFICADO | → | 2️⃣ Registro ABERTO | → | 3️⃣ Ocorrência DESCRITA | → | 4️⃣ Registro SALVO | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Próximo Turno Lê |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![LogBook > Nova Entrada — campo de data, turno, descricao e setor](/screenshots/logbook-nova-entrada.png)
...
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 4, N''+NCHAR(0xD83E)+NCHAR(0xDDED)+N' Visão do Fluxo', N'| 1️⃣ Módulo SELECIONADO | → | 2️⃣ Filtros APLICADOS | → | 3️⃣ Exportação .XLSX | → | 4️⃣ Abertura no EXCEL | → | '+NCHAR(0xD83D)+NCHAR(0xDCCA)+N' Análise e Gráficos |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |', NULL, NULL, NULL, NULL, 1);
INSERT INTO tb_manual_item (codigo_manual, sequencia, titulo, conteudo, tipo_nota, nota, imagem, video, ativo)
VALUES (@codigo, 5, N''+NCHAR(0xD83D)+NCHAR(0xDE80)+N' Passo a Passo', N'![Relatorio > Excel — seleção de módulo e filtros para exportação](/screenshots/excel-modulo.png)
