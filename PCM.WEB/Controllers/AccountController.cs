    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult PasswordReminder(string email)
        {
            ...
            if (emailSenha != "")
            {
                ...
                string assunto = String.Concat("Solicitação de nova senha. - ", TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("E. South America Standard Time")).ToShortDateString(), " ", DateTime.Now.ToShortTimeString());
        ...
        public ActionResult LogOff()
        {
            ...
            Session["dash_desempenho_gov"] = null;
