    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/fullcalendar").Include(
                        "~/Content/js/plugins/fullcalendar/main.min.css"));
            ...
            bundles.Add(new StyleBundle("~/Content/magnificpopup").Include(
                        "~/Content/js/plugins/magnific-popup/magnific-popup.css", new CssRewriteUrlTransform()));

            bundles.Add(new StyleBundle("~/Content/slick").Include(
                        "~/Content/js/plugins/slick/slick.css",
                        "~/Content/js/plugins/slick/slick-theme.css"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/dataTables").Include(
                        ...
                        "~/Content/js/plugins/dataTables/momment.min.js",
                        "~/Content/js/plugins/dataTables/datetime-moment.js",
            ...
            bundles.Add(new ScriptBundle("~/plugins/chartJs").Include(
                      ...
                      "~/Content/js/plugins/chartjs/chartjs-plugin-annotation.min.js"));
            //Chart
            ...
            bundles.Add(new ScriptBundle("~/plugins/calendar").Include(
                        "~/Content/js/plugins/fullcalendar/main.min.js", 
                        "~/Content/js/plugins/fullcalendar/locales-all.min.js"));
            ...
            // Easy Pie Chart
            bundles.Add(new ScriptBundle("~/plugins/easy_pie_chart").Include(
                        "~/Content/js/plugins/easy-pie-chart/jquery.easypiechart.js"));

            // Sidebar
            bundles.Add(new ScriptBundle("~/plugins/magnificpopup").Include(
