...
Imports PCM.TAG.FORM.SQLHelper
    ...
    Public Async Function GetHotelsOpera(ByVal sHostname As String,
        ...
        Using client As New HttpClient()
            ...
            While offset <= totalResults
                ...
                requestMessage = New HttpRequestMessage(HttpMethod.Get, sHostname & "/hsk/v1/hotels/" + sHotelID + "/housekeepingOverview?limit=100&offset=0")
