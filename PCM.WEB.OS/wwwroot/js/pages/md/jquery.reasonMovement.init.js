...
$(document).ready(function () {
    ...
    function editRegister(data) {
        window.location = 'reasonMovementEdit?reasonMovementId=' + data.reasonMovementId;
    }
    ...
    function deleteRegister(data) {
        ...
        swal.fire({
            ...
            if (result.value) {
                jQuery.ajax({
                    method: "POST",
                    url: "deleteReasonMovement",
                    async: false,
                    data: {
                        "reasonMovementId": data.reasonMovementId
                    },
                    dataType: "json",
